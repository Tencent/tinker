    ...
    override fun apply(project: Project) {
        ...
        androidComponents.onVariants { variant ->
            ...
            val compileTestClassTask =
                project.tasks.register("compile${capitalizedVariantName}TestClass", JavaCompile::class.java) {
                    it.group = "build"
            ...
            val buildTestDexTask =
                project.tasks.register("build${capitalizedVariantName}TestDex", BuildTestDexTask::class.java) {
                    it.group = "build"
            ...
            val renameTestDexTest =
                project.tasks.register("rename${capitalizedVariantName}TestDex", RenameTestDexTask::class.java) {
                    it.group = "build"
            ...
            val createTestLibrariesTask =
                project.tasks.register(
                    "create${capitalizedVariantName}TestLibraries",
            ...
            val createTestAssetsTask =
                project.tasks.register("create${capitalizedVariantName}TestAssets", CreateTestAssetsTask::class.java)
            variant.sources.assets
                ?.addGeneratedSourceDirectory(
            ...
            val packageTransformTask =
                project.tasks.register("transform${capitalizedVariantName}Package", PackageTransformTask::class.java)
