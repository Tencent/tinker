...
public class TinkerDexLoader {
    ...
    private static final String TAG = "TinkerDexLoader";
...
//        Log.i(TAG, "loadTinkerJars: opt path: " + optimizeDir.getAbsolutePath());
        ...
        for (ShareDexDiffPatchInfo info : dexList) {
            ...
            if (tinkerLoadVerifyFlag && !SharePatchFileUtil.verifyDexFileMd5(file, info.md5)) {
...
//            e.printStackTrace();
            intentResult.putExtra(ShareIntentUtil.INTENT_PATCH_DEX_EXCEPTION, e);
    ...
    public static boolean checkComplete(String directory, ShareSecurityCheck securityCheck, Intent intentResult) {
        ...
        for (ShareDexDiffPatchInfo info : dexList) {
            ...
            dexes.put(info.realName, info.md5);
        }
    ...
    private static boolean isJustArtSupportDex(ShareDexDiffPatchInfo dexDiffPatchInfo) {
        ...
        String patchMd5 = dexDiffPatchInfo.patchMd5;

        if (patchMd5.equals("0")) {
            return true;
        }
