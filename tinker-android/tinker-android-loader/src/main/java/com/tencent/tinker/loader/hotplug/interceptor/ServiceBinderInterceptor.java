...
public class ServiceBinderInterceptor extends Interceptor<IBinder> {
    ...
    protected IBinder decorate(IBinder target) throws Throwable {
        ...
        if (ITinkerHotplugProxy.class.isAssignableFrom(target.getClass())) {
            ...
            return createProxy(getAllInterfacesThroughDeriveChain(target.getClass()), new FakeClientBinderHandler(target, mBinderInvocationHandler));
        }
    }
    ...
    private static class FakeClientBinderHandler implements InvocationHandler {
        ...
        public Object invoke(Object fakeClientBinder, Method method, Object[] args) throws Throwable {
            if ("queryLocalInterface".equals(method.getName())) {
                ...
                final IInterface originalInterface = (IInterface) asInterfaceMethod.invoke(null, mOriginalClientBinder);
                final InvocationHandler fakeInterfaceHandler = new FakeInterfaceHandler(originalInterface, (IBinder) fakeClientBinder, mBinderInvocationHandler);
