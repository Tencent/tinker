...
public class ActivityStubManager {
    ...
    private static final int[] STANDARD_STUB_COUNT_SLOTS = { ActivityStubs.STANDARD_STUB_COUNT, ActivityStubs.STANDARD_TRSNAPARENT_STUB_COUNT };

    private static final int[] SINGLETOP_STUB_COUNT_SLOTS = { ActivityStubs.SINGLETOP_STUB_COUNT, ActivityStubs.SINGLETOP_TRSNAPARENT_STUB_COUNT };

    private static final int[] SINGLETASK_STUB_COUNT_SLOTS = { ActivityStubs.SINGLETASK_STUB_COUNT, ActivityStubs.SINGLETASK_TRSNAPARENT_STUB_COUNT };

    private static final int[] SINGLEINSTANCE_STUB_COUNT_SLOTS = { ActivityStubs.SINGLEINSTANCE_STUB_COUNT, ActivityStubs.SINGLEINSTANCE_TRSNAPARENT_STUB_COUNT };
