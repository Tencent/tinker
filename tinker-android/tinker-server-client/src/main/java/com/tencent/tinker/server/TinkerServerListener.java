...
public interface TinkerServerListener {
    ...
    File downloadTinkerPatch(Context context, Tinker tinker, TinkerCheckResult checkResult);

    void onPatchDownloaded(Context context, Tinker tinker, File patchFile);
