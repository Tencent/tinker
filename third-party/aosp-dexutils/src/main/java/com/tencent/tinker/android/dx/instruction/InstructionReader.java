        ...
        while (codeIn.hasMore()) {
            ...
            switch (opcodeForSwitch) {
                case Opcodes.SPECIAL_FORMAT: {
                    iv.visitZeroRegisterInsn(opcodeUnit, 0, IndexType.NONE, 0, 0L);
                    break;
                }
                case Opcodes.GOTO: {
                    int baseAddress = codeIn.cursor() - 1;
                    int opcode = InstructionCodec.byte0(opcodeUnit);
                    int target = (byte) InstructionCodec.byte1(opcodeUnit); // sign-extend
                    iv.visitZeroRegisterInsn(opcode, 0, IndexType.NONE, baseAddress + target, 0L);
                    break;
                }
                case Opcodes.NOP:
                case Opcodes.RETURN_VOID: {
                    ...
                    iv.visitZeroRegisterInsn(opcode, 0, IndexType.NONE, 0, literal);
                    break;
                }
                case Opcodes.CONST_4: {
                    ...
                    iv.visitOneRegisterInsn(opcode, 0, IndexType.NONE, 0, literal, a);
                    break;
                }
                ...
                case Opcodes.THROW: {
                    ...
                    iv.visitOneRegisterInsn(opcode, 0, IndexType.NONE, 0, 0L, a);
                    break;
                }
                case Opcodes.MOVE:
                ...
                case Opcodes.REM_DOUBLE_2ADDR: {
                    ...
                    iv.visitTwoRegisterInsn(opcode, 0, IndexType.NONE, 0, 0L, a, b);
                    break;
                }
                case Opcodes.GOTO_16: {
                    ...
                    iv.visitZeroRegisterInsn(opcode, 0, IndexType.NONE, baseAddress + target, literal);
                    break;
                }
                ...
                case Opcodes.SPUT_SHORT: {
                    ...
                    IndexType indexType = IndexType.getIndexType(opcode);
                    iv.visitOneRegisterInsn(opcode, index, indexType, 0, 0L, a);
                    break;
                }
                ...
                case Opcodes.IF_LEZ: {
                    ...
                    int a = InstructionCodec.byte1(opcodeUnit);
                    int target = (short) codeIn.read(); // sign-extend
                    iv.visitOneRegisterInsn(opcode, 0, IndexType.NONE, baseAddress + target, 0L, a);
                    break;
                }
                ...
                case Opcodes.USHR_INT_LIT8: {
                    ...
                    iv.visitTwoRegisterInsn(opcode, 0, IndexType.NONE, 0, literal, a, b);
                    break;
                }
                ...
                case Opcodes.IPUT_SHORT: {
                    ...
                    int index = codeIn.read();
                    IndexType indexType = IndexType.getIndexType(opcode);
                    iv.visitTwoRegisterInsn(opcode, index, indexType, 0, 0L, a, b);
                    break;
                }
                ...
                case Opcodes.IF_LE: {
                    ...
                    int b = InstructionCodec.nibble3(opcodeUnit);
                    int target = (short) codeIn.read(); // sign-extend
                    iv.visitTwoRegisterInsn(opcode, 0, IndexType.NONE, baseAddress + target, 0L, a, b);
                    break;
                }
                ...
                case Opcodes.REM_DOUBLE: {
                    ...
                    iv.visitThreeRegisterInsn(opcode, 0, IndexType.NONE, 0, 0L, a, b, c);
                    break;
                }
                ...
                case Opcodes.SPARSE_SWITCH: {
                    ...
                    int opcode = InstructionCodec.byte0(opcodeUnit);
                    int a = InstructionCodec.byte1(opcodeUnit);
                    int target = baseAddress + codeIn.readInt();
                    ...
                    switch (opcode) {
                        case Opcodes.PACKED_SWITCH:
                        case Opcodes.SPARSE_SWITCH: {
                            codeIn.setBaseAddress(target, baseAddress);
                            break;
                        }
                    }

                    iv.visitOneRegisterInsn(opcode, 0, IndexType.NONE, target, 0L, a);
                    break;
                }
                ...
                case Opcodes.INVOKE_INTERFACE: {
                    ...
                    switch (registerCount) {
                        case 0: {
                            iv.visitZeroRegisterInsn(opcode, index, indexType, 0, 0L);
                            break;
                        }
                        case 1: {
                            iv.visitOneRegisterInsn(opcode, index, indexType, 0, 0L, a);
                        ...
                        case 3: {
                            iv.visitThreeRegisterInsn(opcode, index, indexType, 0, 0L, a, b, c);
                            break;
                        }
                        case 4: {
                            iv.visitFourRegisterInsn(opcode, index, indexType, 0, 0L, a, b, c, d);
                            break;
                        }
                        case 5: {
                            iv.visitFiveRegisterInsn(opcode, index, indexType, 0, 0L, a, b, c, d, e);
                            break;
                        }
                        default: {
                ...
                case Opcodes.INVOKE_INTERFACE_RANGE: {
                    ...
                    int a = codeIn.read();
                    IndexType indexType = IndexType.getIndexType(opcode);
                    iv.visitRegisterRangeInsn(opcode, index, indexType, 0, 0L, a, registerCount);
                    break;
                }
                ...
                case Opcodes.FILL_ARRAY_DATA_PAYLOAD: {
                    ...
                    switch (elementWidth) {
                        case 1: {
                            ...
                            iv.visitFillArrayDataPayloadInsn(opcodeUnit, array, array.length, 1);
                            break;
                        }
                        case 2: {
                            ...
                            iv.visitFillArrayDataPayloadInsn(opcodeUnit, array, array.length, 2);
                            break;
                        }
                        case 4: {
                            ...
                            iv.visitFillArrayDataPayloadInsn(opcodeUnit, array, array.length, 4);
                            break;
                        }
                        case 8: {
                            ...
                            iv.visitFillArrayDataPayloadInsn(opcodeUnit, array, array.length, 8);
                            break;
                        }
                        default: {
                ...
                case Opcodes.PACKED_SWITCH_PAYLOAD: {
                    int baseAddress = codeIn.baseAddressForCursor() - 1; // already read opcode
                    ...
                    iv.visitPackedSwitchPayloadInsn(opcodeUnit, firstKey, targets);
                    break;
                }
                case Opcodes.SPARSE_SWITCH_PAYLOAD: {
                    ...
                    iv.visitSparseSwitchPayloadInsn(opcodeUnit, keys, targets);
                    break;
                }
                default: {
