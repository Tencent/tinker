            ...
            case Opcodes.INVOKE_INTERFACE:
                {
                    ...
                    codeOut.write(InstructionCodec.codeUnit(opcode, InstructionCodec.makeByte(0, 0)), indexUnit, InstructionCodec.codeUnit(0, 0, 0, 0));
                    break;
                }
            default:
                {
    ...
    public void visitFourRegisterInsn(int currentAddress, int opcode, int index, int indexType, int target, long literal, int a, int b, int c, int d) {
        switch(opcode) {
            ...
            case Opcodes.INVOKE_INTERFACE:
                {
                    short indexUnit = (short) index;
                    codeOut.write(InstructionCodec.codeUnit(opcode, InstructionCodec.makeByte(0, 4)), indexUnit, InstructionCodec.codeUnit(a, b, c, d));
                    break;
                }
            default:
                {
    ...
    public void visitFiveRegisterInsn(int currentAddress, int opcode, int index, int indexType, int target, long literal, int a, int b, int c, int d, int e) {
        switch(opcode) {
            ...
            case Opcodes.INVOKE_INTERFACE:
                {
                    short indexUnit = (short) index;
                    codeOut.write(InstructionCodec.codeUnit(opcode, InstructionCodec.makeByte(e, 5)), indexUnit, InstructionCodec.codeUnit(a, b, c, d));
                    break;
                }
            default:
                {
    ...
    public void visitRegisterRangeInsn(int currentAddress, int opcode, int index, int indexType, int target, long literal, int a, int registerCount) {
        switch(opcode) {
            ...
            case Opcodes.INVOKE_INTERFACE_RANGE:
                {
                    short indexUnit = (short) index;
                    codeOut.write(InstructionCodec.codeUnit(opcode, registerCount), indexUnit, InstructionCodec.getAUnit(a));
                    break;
                }
            default:
                {
